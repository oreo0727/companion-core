...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-surface text-ink">
      <aside className="fixed inset-y-0 left-0 z-20 hidden w-72 border-r border-line bg-surface-raised lg:block">
      ...
      <div className="lg:pl-72">
        <header className="sticky top-0 z-10 border-b border-line bg-surface-raised/95 backdrop-blur">
          <div className="flex min-h-16 items-center justify-between gap-3 px-4 sm:px-6">
            ...
            <div className="flex items-center gap-2">
              <div className="hidden items-center gap-2 rounded-md border border-line px-3 py-2 text-xs text-ink-muted md:flex">
              ...
              <button
                type="button"
                onClick={toggleTheme}
                className="flex h-9 w-9 items-center justify-center rounded-md border border-line text-ink-muted hover:bg-surface-muted hover:text-ink"
        ...
        <main className="mx-auto w-full max-w-7xl px-4 py-5 sm:px-6">
          <div className="mb-4 rounded-md border border-line bg-surface-raised px-4 py-3 text-sm text-ink-muted">
            Signed in as{" "}
